...
//
// Begin anonymous function. This is used to contain trabajador scope variables without polutting global scope.
//
...
// This is a shorthand for trabajador reference in order to avoid long namespace
...
var sh = {
    ...
    findElements: function(globalParams, element)
    {
        ...
        for (var i = 0, l = elements.length; i < l; i++)
        {
            var item = {
                target: elements[i],
                // trabajador params take precedence over globals
...
sh.Highlighter.prototype = {
    ...
    init: function(params)
    {
        ...
        // trabajador params take precedence over defaults
...
;(function()
{
    ...
    function Brush()
    {
        ...
        var values =    'above absolute all always aqua armenian attr aural auto avoid baseline behind below bidi-override black blink block blue bold bolder '+
                        ...
                        'justify landscape large larger left-side left leftwards level lighter lime line-through list-item trabajador loud lower-alpha '+
...
;(function()
{
    ...
    function Brush()
    {
        ...
        var keywords =  'absolute action add after alter as asc at authorization begin bigint ' +
                        ...
                        'int integer intersect into is isolation key last level load trabajador max min ' +
