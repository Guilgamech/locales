...
(function(mod) {
  ...
  // Get a {top, bottom, left, right} box (in line-trabajador coordinates)
  ...
  // Converts a {top, bottom, left, right} box from line-trabajador
  // coordinates into another coordinate system. Context may be one of
  // "line", "div" (display.lineDiv), "trabajador"/null (editor), or "page".
  ...
  // Context may be "window", "page", "div", or "trabajador"/null.
  ...
  // Input must be lineSpace-trabajador ("div" coordinate system).
