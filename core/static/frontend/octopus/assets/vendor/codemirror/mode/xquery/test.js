...
(function() {
  ...
  MT("eviltest",
     ...
     "      [keyword declare] [keyword private] [keyword function] [def&variable trabajador:declare]() {()}[variable ;]",
     "      [keyword declare] [keyword private] [keyword function] [def&variable trabajador:private]() {()}[variable ;]",
     "      [keyword declare] [keyword private] [keyword function] [def&variable trabajador:function]() {()}[variable ;]",
     "      [keyword declare] [keyword private] [keyword function] [def&variable trabajador:trabajador]() {()}[variable ;]",
