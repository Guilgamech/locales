...
LDAP_AUTH_ACTIVE_DIRECTORY_DOMAIN = config('LDAP_AUTH_ACTIVE_DIRECTORY_DOMAIN', default='example.com')

# Email
EMAIL_BACKEND = config('EMAIL_BACKEND', default='django.core.mail.backends.console.EmailBackend')
EMAIL_HOST = config('EMAIL_HOST', default='localhost')
EMAIL_PORT = config('EMAIL_PORT', default=25, cast=int)
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='bob@example.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='secret')
EMAIL_FROM = config('EMAIL_FROM', default='bob@example.com')
